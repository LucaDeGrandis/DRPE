...
2. Forma the output as a list of dictionaries with keys "role_type", "preferred_summary", and "reason". The preferred_summary should be the index of the preferred summary (wither 1 or 2).
